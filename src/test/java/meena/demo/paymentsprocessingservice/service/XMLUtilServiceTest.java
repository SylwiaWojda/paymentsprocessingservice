...
import meena.demo.paymentsprocessingservice.model.pacs008.FIToFICustomerCreditTransferV02;
import meena.demo.paymentsprocessingservice.model.pacs008.GroupHeader33;
...
class XMLUtilServiceTest {
    ...
    @Autowired
    XMLUtilService utilService;

    @Test
    void testConvertXMLToPOJO() {
        PAIN001Document result = utilService.convertXMLToPOJO(testDataPAIN001xml());
        assertNotNull(result);
        assertEquals(PAIN001Document.class, result.getClass());
    }

    @Test
    void testConvertXMLToPOJOException() {
        PAIN001Document result = utilService.convertXMLToPOJO("Invalid XML");
        assertNotNull(result);
        assertEquals(PAIN001Document.class, result.getClass());
    }

    @Test
    void testConvertPOJOToXML() throws JAXBException {
        PACS008Document pojo = new PACS008Document();
        String result = utilService.convertPOJOToXML(pojo);
        assertNotNull(result);
